          ...
          <div className="relative bg-white w-[90%] max-w-lg rounded-2xl shadow-2xl p-6 md:p-8">
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                window.location.href = `mailto:info@cestoai.com?subject=${subject}&body=${body}`;
              }}
            >
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-md bg-[#10b981] text-white hover:bg-[#059669]"
                >
                  Send email
                </button>
              </div>
              <p className="text-xs text-gray-500 pt-2">
                This opens your email client to contact info@cestoai.com
              </p>
            </form>
          </div>
        </div>
